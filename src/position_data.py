...
def position_data_motion(veh, striking=False):
    ...
    for i in (range(len(veh.model.t))):
        ...
        veh.p_vx = veh.p_vx.append({'b_lfc': veh.lcgf + veh.f_hang,     # body outline
                                  ...
                                  'lfw_a': veh.lcgf + veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - -1 * veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'lfw_b': veh.lcgf + veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'lfw_c': veh.lcgf + -1 * veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'lfw_d': veh.lcgf + -1 * veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - -1 * veh.tire_w / 2*math.sin(veh.model.loc[i,'delta_rad']),
                                  'rfw':   veh.lcgf,                         # Right front wheel
                                  'rfw_a': veh.lcgf + veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - -1 * veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'rfw_b': veh.lcgf + veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'rfw_c': veh.lcgf + -1 * veh.tire_d / 2 * math.cos(veh.model.loc[i,'delta_rad']) - veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  'rfw_d': veh.lcgf + -1 * veh.tire_d / 2*math.cos(veh.model.loc[i,'delta_rad']) - -1 * veh.tire_w / 2 * math.sin(veh.model.loc[i,'delta_rad']),
                                  ...
                                  'vel_v': veh.model.vx[i] / 10}, ignore_index=True)  # line for velocity vector
        ...
        veh.p_vy = veh.p_vy.append({'b_lfc': -1 * veh.v_width / 2,     # body outline
                                  ...
                                  'lfw_a': -1 * (veh.v_width / 2 - veh.tire_w / 2) + veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + -1 * veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'lfw_b': -1 * (veh.v_width / 2 - veh.tire_w / 2) + veh.tire_d / 2 *math.sin(veh.model.loc[i,'delta_rad']) + veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'lfw_c': -1 * (veh.v_width / 2 - veh.tire_w / 2) + -1 * veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'lfw_d': -1 * (veh.v_width / 2 - veh.tire_w / 2) + -1 * veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + -1 * veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'rfw':   (veh.v_width / 2 - veh.tire_w / 2),                         # Right front wheel
                                  'rfw_a': (veh.v_width / 2 - veh.tire_w / 2) + veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + -1 * veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'rfw_b': (veh.v_width / 2 - veh.tire_w / 2) + veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'rfw_c': (veh.v_width / 2 - veh.tire_w / 2) + -1*veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  'rfw_d': (veh.v_width / 2 - veh.tire_w / 2) + -1*veh.tire_d / 2 * math.sin(veh.model.loc[i,'delta_rad']) + -1 * veh.tire_w / 2 * math.cos(veh.model.loc[i,'delta_rad']),
                                  ...
                                  'vel_v': veh.model.vy[i] / 10}, ignore_index=True)  # line for velocity vector
