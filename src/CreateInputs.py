...
def create_inputs():
    ...
    # create table of project data to display
    inputtable = pd.DataFrame(index = input_query, columns = [veh1_data, veh2_data])

    inputtable.tocsv(f'{pname}_Inputs.csv')
